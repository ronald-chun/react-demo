		...
		return (
			<div className="App">
				...
				<div className='App-content'>
					<p>{ this.props.data.lastRefrech
						? moment(this.props.data.lastRefrech).format('LLLL:ss')
						: '' }</p>
						...
						!this.props.data
							...
							this.props.data.isFetching
								...
								: this.props.data.data.map((item, key) => {
									return <InfoCard key={ item.location }
									                 title={ item.location }
									                 queueNum={ item.count }
					...
					<span>{ this.props.redditData.lastRefrech
						? moment(this.props.redditData.lastRefrech)
							.format('LLLL:ss')
						: '' }</span>
					<div>
						<ul>
							{
								!this.props.redditData.data.data
									...
									this.props.redditData.isFetching
										? <p>Fetching...</p>
										: this.props.redditData.data.data.children.map(
										(item, key) => {
